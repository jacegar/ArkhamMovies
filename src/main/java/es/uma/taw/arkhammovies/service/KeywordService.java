...
public class KeywordService extends DTOService<KeywordDTO, Keyword> {
    ...
    public Map<String, Double> getKeywordsOrderedByFrequency() {
        List<Object[]> results = keywordRepository.getKeywordsOrderedByFrequency();
        return GenreService.getFrequencyMap(results, movieRepository);
    }
